...
class DataTransformation:
    ...
    def get_data_transformation_object(cls) -> Pipeline:
        ...
        try:
            ...
            logging.info(f"Initilize the KNNImpuer object with the parameters: {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
            processor:Pipeline = Pipeline([("imputer", KNNImputer_object)])
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            logging.info("Reading the valid train data")
            ...
            save_object("final_model/model.pkl", preprocessor_object)
            # preparing artifacts
